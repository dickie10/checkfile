...
<h3 class="news">OGC navigator - Jacobs University supports OGC certification </h3><p><b>
...
Further information: <a href=http://jacobs-university.de/ogc>http://jacobs-university.de/ogc</a> and email <a href="mailto:p.baumann@jacobs-university.de">p.baumann@jacobs-university.de</a> .
</p><p>
        </div><!--/row-fluid-->
    </div><!--/container-->
    <!--=== End Content Part ===-->
